                ...
                <form onSubmit={handleAuthSubmit} className="space-y-4 text-left">
                    ...
                    <div>
                      ...
                      <AnimatePresence>
                        {isCapsLockOn && (
                          ...
                          >
                            <div 
                              className="flex items-center gap-2 px-3.5 py-2.5 bg-amber-50 border border-amber-200/60 rounded-xl text-amber-800 text-xs font-semibold shadow-sm text-left"
                  ...
                  {authModal !== "forgot" && (
                    <>
                      ...
                      <div className="grid grid-cols-2 gap-3" id="social_login_grid">
                        <button
                          type="button"
                        ...
                        >
                          ...
                          <span>Sign in with Apple Device</span>
                        </button>
                      </div>
                    </>
                  )}
